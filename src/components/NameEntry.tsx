...
import { SetPlayerNameRequest, SetPlayerNameResponse } from "@/api/Player";
 ...
 * @param setPlayerName a function that is called with the name as an argument when the server accepts the name
 * @returns a form that allows the user to enter their name
 */
function NameEntry({ setPlayerName }: { setPlayerName: (name: string) => void }) {
